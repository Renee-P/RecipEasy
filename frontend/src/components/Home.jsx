...
function Home() {
  const [menuVisible, setMenuVisible] = useState(false); // Toggle menu visibility
  const [results, setResults] = useState(null); // Manage results data
  ...
  // Function to handle results from CustomizeForm
